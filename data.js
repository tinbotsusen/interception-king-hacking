...
const ENEMIES = [
  ...
  { s:14, n:"サイバー犯罪集団", e:"👥", hp:280, atk:3200, dmg:10, msg:"我々はレギオン。数による暴力に屈せよ", spw: 400, t:{r:0.2, s:'basic'}, blk:0.5, limit: 1500, 
...
const REPS=["尊い…","ｐｒｐｒ（＾ω＾）","それってあなたの感想ですよね","デュフフｗｗｗ","控えめに言って女神","加工しすぎでワロタｗ 誰だよこれｗ","通報しました","自演乙","マジ天使。結婚してくれ","炎上しろ炎上しろ炎上しろ","スパチャ3万投げたお！姫、見てる！？"];
